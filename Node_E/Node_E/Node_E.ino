...
char ssid[] = "GALILAO";
char pass[] = "BUU1234PM";
//char auth[] = "2d2814f7a9164ad6aae9f6ba83b572a3"; //Token ของ Node E ของเม
//char auth1[] = "c0ba87394c8a4379924136cfc0661848";  //Token ของ Server ของเม
//char auth[] = "6517baf423764d908b4845da2404097b";  //Token ของ Node E ของหอม
//char auth1[] = "6f14574d7fd641e5963d1888f40e51c7"; //Token ของ Server ของหอม
char auth[] = "ad4a2d01b67a4c2290e387dbc6b66fd0";  //Token ของ Node E ของคอม
...
void sendSensor(){
    ...
    bridge1.virtualWrite(V19, h); //Node A ส่งค่าความชื้นไปให้ Server
    bridge1.virtualWrite(V20, t); //Node A ส่งค่าอุณหภูมิไปให้ Server
    }               
}
